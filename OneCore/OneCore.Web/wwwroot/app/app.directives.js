(() => {
    ...
    app.directive("password", ["defaultErrorMessageResolver", function (defaultErrorMessageResolver) {
        defaultErrorMessageResolver.getErrorMessages().then(function (errorMessages) {
            errorMessages['password'] = 'La contraseña debe contener lo menos una mayúscula, una minúscula, un símbolo y un numero';
        });
        ...
        return {
            ...
            link: function (scope, element, attributes, ngModel) {
                ngModel.$validators.password = function (modelValue) {
                    ...
                    var regex = /^(?=.*[!@#$%^&*()_+=\[{\]};:<>|./?,\\'""-])(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z!@#$%^&*()_+=\[{\]};:<>|./?,\\'""-]{10,}$/;
                ...
                ngModel.$parsers.push(parsePassword);
